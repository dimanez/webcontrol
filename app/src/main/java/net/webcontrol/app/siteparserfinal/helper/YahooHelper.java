...
/**
 * Created by Дима on 20.03.2016.
 */
public class YahooHelper {
    TagNode rootNode;

    public YahooHelper(URL htmlPage) throws IOException
    {
        System.out.println("Start YahooHelper");
    ...
    public List<TagNode> getLinksByClass(String CSSClassname)
    {
        ...
        //Выбираем все ссылки
        TagNode linkElements[] = rootNode.getElementsByName("span",false);
